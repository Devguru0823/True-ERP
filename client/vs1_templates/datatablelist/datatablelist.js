                ...
                "fnInitComplete": function (oSettings) {
                      ...
                      if(templateObject.data.islistfilter == true){
                        $(`<div class="btn-group divDropdownFilter ${currenttablename}" style="margin-left: 14px;">
                            <button type="button" class="btn btn-primary ${currenttablename} btnDropdownFilter" id="btnDropdownFilter" name="btnDropdownFilter" tablename="${currenttablename}"><i class="fas fa-list-ul" style="margin-right: 5px;"></i>Filter</button>
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item btnFilterOption1 pointer" id="" data-toggle='modal' data-target="#customFilterModal_${currenttablename}">${templateObject.data.exportfilename} Filter 1</a>
                                <a class="dropdown-item btnFilterOption2 pointer" id="" data-toggle='modal' data-target="#customFilterModal_${currenttablename}">${templateObject.data.exportfilename} Filter 2</a>
                            </div>
